...
帳號：<input type="text" name="r_us"><br>
密碼：<input type="password" name="r_pw"><br>
<input type="submit" value="確定" name="registered"><br>
已有會員請點這!<input type="button" value="登入" onclick="location.href='login(ann).php'"><br><br>
<?php
$hn='127.0.0.1';
$db='perfume';
$us='root';
